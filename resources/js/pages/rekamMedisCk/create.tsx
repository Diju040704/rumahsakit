...
export default function CreateRekamMedis({ pasiens }: Props) {
    const [kesehatanPasienOptions, setKesehatanPasienOptions] = useState<KesehatanPasien[]>([]);
    const [selectedPasienId, setSelectedPasienId] = useState(0);

    const form = useForm<z.infer<typeof formSchema>>({
        resolver: zodResolver(formSchema),
        defaultValues: {
            pasien_id: 0,
            kesehatan_pasien_id: 0,
            file: undefined,
            catatan: '',
        },
    });
