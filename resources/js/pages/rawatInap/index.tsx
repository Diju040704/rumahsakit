...
import { Pasien, RawatInap, type BreadcrumbItem } from '@/types';
import { can } from '@/utils/permission';
import { Head, useForm, usePage } from '@inertiajs/react';
import { useEffect, useState } from 'react';
import { toast } from 'sonner';
import {  RawatInapColumns } from './columns';
...
export default function PasienIndex({ rawatInaps, flash }: Props) {
    const [open, setOpen] = useState(false);
    const [pasienToDelete, setPasienToDelete] = useState<number | null>(null);

    console.log(rawatInaps);
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <DataTable columns={RawatInapColumns(canEdit, canDelete, handleDelete)} data={rawatInaps} page="rawatInap" canCreate={canCreate} />
